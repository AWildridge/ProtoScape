...
public final class Inventory implements Cloneable {
    ...
    public void transfer(Inventory offer, Inventory inventory) {
        for (int i = 0; i < offer.getItems().length; i++) {
            if (offer.get(i) != null) {
                add(offer.get(i).getId(), offer.get(i).getAmount());
                offer.remove(offer.get(i));
            }
        }
    }
    ...
    /**
     * Checks if this inventory contains an item with the specified id and amount
     * @param id The item's id.
     * @param amount is items amount
    ...
    /**
     * Removes {@code amount} of the item at the specified {@code slot}, under the condition that this item
     * matches the specified {@code id}. If the item is not stacked, it will only remove the single item at
     * the slot (meaning it will ignore any amount higher than 1). This means that this method will under no
     * circumstances make any changes to other slots.
     * @param slot The slot.
     ...
     * @param id The id.
     * @return The first found slot (starting at 0) containing the specified item, or {@code -1} if none of
     * the slots matched the conditions.
     */
     ...
     * 
     * @param item The item to remove.
     * @param slot The slot the item is removed from.
     * @return The amount that was removed.
     */
    ...
    public void setFiringEvents(boolean flag) {
        firingEvents = flag;
    }
