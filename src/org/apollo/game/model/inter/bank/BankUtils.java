...
public final class BankUtils {
	...
	public static void openBank(Player player) {
	    	if(player.isPinSet()) {
	    		...
	    		if(!player.getBankPin().canOpenBank())
	    		    return;
	    	    }
	    	} else {
	    		player.sendMessage("It is highly recommended that you set a pin.");
	    		player.sendMessage(" You can do that by doing the command '::setpin'");
	    	}
