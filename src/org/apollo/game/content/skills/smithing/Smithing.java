package org.apollo.game.content.skills.smithing;

import org.apollo.game.action.impl.SmeltingAction;
import org.apollo.game.action.impl.SmithingAction;
...
public class Smithing {
    ...
    public static int[] primaryOre = {436, 440, 442, 440, 444, 447, 449, 451};
    public static int[] levelReq = {1, 15, 20, 30, 40, 50, 70, 85};
    public static Item[] bars = {new Item(2349), new Item(2351), new Item(2355), new Item(2353), new Item(2357), new Item(2359), new Item(2361), new Item(2363)};
    public static Item[] secondaryOres = {new Item(438), null, null, new Item(453, 2), null, new Item(453, 4), new Item(453, 6), new Item(453, 8)};
    public static double[] exp = {6.2, 12.5, 13.7, 17.5, 22.5, 30.0, 37.5, 50.0};
    static int[] barNameIds = {3987, 3991, 3995, 3999, 4003, 7441, 7446, 7450};
    public static int type, amt, barsReq, barIndex;
    static Position loc;
            ...
            if (type == barTypes[i]) {
                for (int j = 0; j < smithedItems[i].length; j++) {
                    if (itemId == smithedItems[i][j].getId()) {
                        ...
                        player.startAction(new SmithingAction(player, itemId));
                    }
                }
            }
        }
    ...
    public static void handleSmelting(final Player player, final int index, int amount) {
        ...
        player.startAction(new SmeltingAction(player, index));
    }
}