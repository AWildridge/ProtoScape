...
public class TradeLitsener implements InterfaceListener {
	 ...
	 */
	public TradeLitsener(Player player, InventoryListener invListener, InventoryListener shopListener) {
		this.player = player;
