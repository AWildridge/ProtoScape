...
public final class Animation {
     ...
     */
    public static final Animation EAT = new Animation(829);

    /**
     * The firemaking animation.
     */
    public static final Animation FIRE_MAKING = new Animation(733);

    /**
     * The burying animation.
     */
    public static final Animation BURY = new Animation(827);

    /**
     * The fletching animation.
     */
    public static final Animation FLETCHING = new Animation(887);
