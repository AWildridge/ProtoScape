...
import org.apollo.game.scheduling.impl.BuildFriendsTask;
...
public final class Server {
	...
	public Server() throws Exception {
        System.out.println(""
                +"             _____           _        _____"
                +"\n            |  __ \\         | |      / ____|   "
                +"\n            | |__) | __ ___ | |_ ___| (___   ___ __ _ _ __   ___ "
                +"\n            |  ___/ '__/ _ \\| __/ _ \\\\___ \\ / __/ _` | '_ \\ / _ \\"
                +"\n            | |   | | | (_) | || (_) |___) | (_| (_| | |_) |  __/"
                +"\n            |_|   |_|  \\___/ \\__\\___/_____/ \\___\\__,_| .__/ \\___|"
                +"\n                                                     | |         "
                +"\n                                                     |_| "
                +"\n-----------------------------------------------------------------------"
                +"\n     Developed by The Wanderer, Ares_, Arrowzftw, and Imsuperman05"
                +"\n                            See ProtoScape.org"
                +"\n-----------------------------------------------------------------------");
