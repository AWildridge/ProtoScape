...
public final class InterfaceSet {
	 ...
	 * @param sidebarId The sidebar's id.
	 */
	public void openWindowWithSidebar(int windowId, int sidebarId,  boolean close) {
		openWindowWithSidebar(null, windowId, sidebarId, close);
	}
	 ...
	 * @param sidebarId The sidebar's id.
	 */
	public void openWindowWithSidebar(InterfaceListener listener, int windowId, int sidebarId, boolean close) {
		if(close) {
                    closeAndNotify();
                }
		this.listener = listener;
