...
public class WeaponInterfaces {
	...
	public static void sendWeaponInterface(Player player, int id, String name, String genericName) {
		...
		if (name.equals("unarmed")) {
			...
			player.getEventManager().sendString(1767, genericName);
                	...
                	player.sendSidebarInterface(0, 425);
			player.send(new SetInterfaceModelEvent(426, 200, id));
			player.getEventManager().sendString(428, genericName);    
        ...
        public static void UpdateWep(Player player) {
                ...
                if(item != null) {
                    WeaponInterfaces.sendWeaponInterface(player, item.getId(), itemName, genericName);
                } else {
                    WeaponInterfaces.sendWeaponInterface(player, -1, itemName, genericName);
                }
        }
