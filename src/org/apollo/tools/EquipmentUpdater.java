...
public final class EquipmentUpdater {
            ...
            try {
                ...
                for (int id = 0; id < defs.length; id++) {
                    ...
                    if (type != -1) {
                        ...
                        os.writeByte(getWeaponSpeed(def));
                        os.writeBoolean(hasSpecial(def));
                        os.writeShort(getStandAnim(def));
                        os.writeShort(getRunAnim(def));
                        os.writeShort(getWalkAnim(def));
                        os.writeShort(getAttackAnimOneId(def));
                        os.writeByte(getPoisonType(def));
                        os.writeByte(getSpecialConsumption(def));
                        os.writeByte(getSpecialHits(def));
                    }
                }
            } finally {
                fs.close();
    ...
    private static int getAttackAnimOneId(ItemDefinition def) {
        String name = def.getName();
        if(name.contains("scimitar") || name.contains("mace") || name.contains("sword") || name.contains("ket-em")) {
            return 451;
        } else if(name.contains("battleaxe") || name.contains(" axe") || name.contains("xil-ek")) {
            return 395;
            ...
            return 2067;
        } else if(name.contains("dagger") || name.contains(" spear")
                || name.contains("xil-ak")) {
            return 400;
        } else if(name.contains("Staff") || name.contains(" staff") || name.contains("mej-tal")) {
            return 414;
        } else if(name.contains("xil-ul")) {
            return 2614;
        } else if(name.contains("bow")) {
            return 426;
        } else if(name.contains("warspear")) {
            return 2080; 
        } else if(name.contains("Karils crossbow")) {
            return 2075;
        } else if(name.contains("hammers")) {
            return 2068;
    ...
    /**
     * Gets the number of hits dealt when using a special attack.
     * @param def The item's definition.
     * @return The number of hits dealt when using a special attack.
     */
    private static int getSpecialHits(ItemDefinition def) {
        int id = def.getId();
        if (id == 1215 || id == 1231 || id == 5680 || id == 5698 || id == 861) {
            return 2;
        }
        return 1;
    }
    ...
    /**
     * Gets the percentage of the special bar consumed while using a special attack.
     * @param def The item's definition.
     * @return The percentage of the special bar consumed.
     */
    private static int getSpecialConsumption(ItemDefinition def) {
        int id = def.getId();
        if (id >= 7639 && id <= 7648) {
            return 10;
        } else if (id == 1215 || id == 1231 || id == 5680 || id == 5698 || id == 1434
                || id == 1249 || id == 1263 || id == 3176 || id == 5716 || id == 5730
                || id == 3101) {
            return 25;
        } else if (id == 3204) {
            return 30;
            ...
            return 35;
        } else if (id == 4151 || id == 4153 || id == 6746) {
            return 50;
        } else if (id == 861) {
            return 55;
        } else if (id == 7158) {
            return 60;
        } else if (id == 1377 || id == 6739 || id == 35 || id == 6724) {
            return 100;
        }
        return 0;
    }
    ...
    /**
     * Gets the poison type as a number.
     * Poison = 1; Extra = 2; Super = 3; karambwan = 4; none = 0;
     * @param def
     * @return 
     */
    private static int getPoisonType(ItemDefinition def) {
        String name = def.getName();
        if (name.contains("(p)")) {
            return 1;
     ...
     * @return The speed.
     */
    private static int getWeaponSpeed(ItemDefinition def) {
        String name = def.getName();
        if (name == null) {
            name = "null";
        }
        if (name.contains("dart") || name.equals("knife")) {
            return 3;
        } else if (name.contains("dagger") || name.contains("shortsword") || name.contains("scimitar")
                || name.contains("shortbow") || name.contains("Kharils crossbow") || name.contains("Toktz-xil")
                || name.contains("claws") || name.contains("Abbysal whip") || name.contains("Saradomin staff")
                || name.contains("Zamorak staff") || name.contains("Guthix staff") || name.contains("Slayer staff")
                || name.contains("Ancient staff")) {
            return 4;
        } else if (name.contains("Ahrims staff")) {
            return 6;
        } else if (name.contains("longsword") || name.contains("mace") || name.contains(" axe")
                || name.contains("spear") || name.contains("pickaxe") || name.contains("Tzhaar-ket-em")
                || name.contains("Torags hammers") || name.contains("flail") || name.contains("staff")
                || name.contains("Staff") || name.contains("thrownaxe") || name.contains("Comp ogre")
                || name.contains("Crystal bow") || name.contains("Seercull")) {
            return 5;
        } else if (name.contains("battleaxe") || name.contains("warhammer") || name.contains("Toktz-mej")
                || name.contains("longbow") || name.contains("javelin") || name.contains("crossbow")) {
            return 6;
        } else if (name.contains("2h") || name.contains("maul") || name.contains("halberd")
                || name.contains("Tzhaar-ket-om") || name.contains("Ivandis") || name.contains("greataxe")) {
            return 7;
     ...
     * @return {@code true} if so, {@code false} otherwise.
     */
    private static boolean hasSpecial(ItemDefinition def) {
        int id = def.getId();
        if (id >= 7639 && id <= 7648) {
            return true;
        } else if (id == 4151 || id == 4153 || id == 805 || id == 861 || id == 5698 || id == 1215
                || id == 1231 || id == 1249 || id == 1263 || id == 1305 || id == 1377 || id == 1434
                || id == 3176 || id == 3204 || id == 4587 || id == 5680 || id == 5716 || id == 5730
                || id == 6739 || id == 7158 || id == 6746 || id == 35 || id == 859 || id == 3101
                || id == 6724) {
            return true;
        } else {
            return false;
    ...
    /**
     * Gets the item's stand animation id.
     * @param def The item.
     * @return The stand animation id.
     */
    private static int getStandAnim(ItemDefinition def) {
        int id = def.getId();
        String name = def.getName();
        if (id == 4153) {
            return 1662;
            ...
            return 809;
        } else if (name.contains("staff") || name.contains("Staff")) {
            return 813;
        } else if (name.contains("2h") || name.contains("greataxe") || id == 6528) {
            return 2065;
        } else if (id == 4755) {
            return 2061;
        } else if (id == 4734) {
    ...
    /**
     * Gets the item's run animation id.
     * @param def The item.
     * @return The run animation id.
     */
    private static int getRunAnim(ItemDefinition def) {
        int id = def.getId();
        String name = def.getName();
        if (id == 4153 || id == 6528) {
            return 1664;
        } else if (name.contains("spear") || name.contains("staff") || name.contains("Staff")) {
            return 1210;
        } else if (id == 4755) {
            return 1831;
        } else if (id == 4734) {
    ...
    /**
     * Gets the item's walk animation id.
     * @param def The item.
     * @return The walk animation id.
     */
    private static int getWalkAnim(ItemDefinition def) {
        int id = def.getId();
        String name = def.getName();
        if (id == 4153) {
            return 1663;
    ...
    private static boolean isFullHat(ItemDefinition def) {
        ...
        for (int i = 0; i < EquipmentConstants.FULL_HATS.length; i++) {
            if (name.contains(EquipmentConstants.FULL_HATS[i])) {
                return true;
            }
        }
        return false;
    ...
    private static boolean isFullMask(ItemDefinition def) {
        ...
        for (int i = 0; i < EquipmentConstants.FULL_MASKS.length; i++) {
            if (name.contains(EquipmentConstants.FULL_MASKS[i])) {
                return true;
            }
        }
        return false;
