...
public final class SkillSet {
     ...
     */
    public static final double MAXIMUM_EXP = Integer.MAX_VALUE;
    /**
    ...
    public int getCombatLevel() {
        ...
        int combat = (int) (.25 * ((1.3 * (attack + strength)) + defence + hitpoints + (prayer / 2)));
    ...
    public void increaseLevel(int skill, int amount) {
        ...
        cur += amount;
        setSkill(skill, new Skill(skills[skill].getExperience(), cur, skills[skill].getMaximumLevel()));
    }
    ...
    public void refreshSkills() {
        for(int i = 0; i < skills.length; i++) {
            setSkill(i, new Skill(skills[i].getExperience(), skills[i].getMaximumLevel(), skills[i].getMaximumLevel()));
        }
    }
